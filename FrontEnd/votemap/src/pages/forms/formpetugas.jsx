...
function PageAddAdminTps() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "https://r18tprb3-8000.asse.devtunnels.ms/admin?role=adminTps",
        {
          headers: {
      ...
      <div className="d-flex justify-content-around align-items-center">
        <div className="mb-3 p-4 d-flex gap-3">
          <div>
            ...
            <input
              type="text"
              placeholder="Ketikkan Nama/Username/TPS..."
...
export default PageAddAdminTps;
